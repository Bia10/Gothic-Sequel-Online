...
{
	return *(HINSTANCE*)0x008B50C8; //hInstApp
};
...
{
	*(LPCSTR*)0x0087F7F0 = (LPCSTR)windowName; //¯eby ta opcja dzia³a³a musi zostaæ uruchomiona przed zainicjowaniem okna gothica
