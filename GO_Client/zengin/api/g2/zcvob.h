...
public:
	zCEventManager* __fastcall GetEM(int p1 = 0){ XCALL(0x005F3D80);};
	void SetAI(zCAIBase* ){XCALL(0x005F2910);};
	void SetSleeping(int){ XCALL(0x005F68A0); };
	...
	*/
	...
	void RemoveVobFromWorld(void){XCALL(0x005F5BB0)};
	...
	* @usable Ingame only
	*/
	void ResetRotationsWorld() {XCALL(0x0060F430);};
	...
	*/
	...
	//oCVob
	void SetOnFloor(zVEC3& centerPos){XCALL(0x0070B650);};
